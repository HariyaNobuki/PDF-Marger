...
if __name__ == '__main__':
    ...
    ## M2 Summary Marge
    """横"""
    M2_path = os.path.join(pdf,"done")
    merger = pypdf.PdfMerger()
    merger.append(os.path.join(pdf,"表紙","2023","表紙2023_予稿.pdf"))
    for ind in M2:
        print(ind)
    ...
    merger.write(os.path.join(pdf,'2023年度中田研_予稿集先生用.pdf'))
    merger.close()
